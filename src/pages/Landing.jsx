...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      {/* ===================== FOOTER — elegant back cover ===================== */}
      <footer className="relative snap-start overflow-hidden bg-art-ink text-art-bg">
        ...
        <div className="container-page relative flex min-h-[86vh] flex-col justify-center py-24">
          <motion.p
            ...
            viewport={vp}
            transition={{ duration: 0.7 }}
            className="label text-brand-accent"
          >
            — Let’s connect —
          </motion.p>
          ...
          <motion.h2
            ...
            viewport={vp}
            transition={{ duration: 0.9, ease }}
            className="mt-5 max-w-3xl font-display text-4xl leading-[1.05] sm:text-6xl"
          >
            Two sides, one story —{' '}
            <span className="font-script text-5xl text-brand-accent sm:text-7xl">let’s make something.</span>
          </motion.h2>

          {/* the three profile logos */}
          <div className="mt-14 flex flex-wrap items-start gap-8 sm:gap-12">
            {[
